...
export default function Experience() {
    ...
    const dots = [
        { start: { lat: -34.6, lng: -58.38 }, end: { lat: 40.71, lng: -74.0 } },
        { start: { lat: -34.6, lng: -58.38 }, end: { lat: 48.85, lng: 2.35 } },
        { start: { lat: -34.6, lng: -58.38 }, end: { lat: -60, lng: -70 } },
        { start: { lat: -34.6, lng: -58.38 }, end: { lat: 35.68, lng: 139.69 } },
        { start: { lat: -34.6, lng: -58.38 }, end: { lat: 1.35, lng: 103.82 } },
        { start: { lat: -34.6, lng: -58.38 }, end: { lat: 65, lng: 100 } }
    ]
    ...
    return (
        ...
        <section
            ref={ref}
            className={`relative bg-white py-28 px-6 transition-all duration-700
  ${inView ? "opacity-100 translate-y-0" : "opacity-100 translate-y-4"}`}
        >
            <div className="w-full mx-auto grid md:grid-cols-2 gap-16 items-center">
