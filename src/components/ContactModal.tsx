...
export default function ContactModal({
    ...
    const [service, setService] = useState(defaultService || "Seleccionar servicio");
                    ...
                    >
                        <div className="relative w-full max-w-5xl max-h-[92vh] overflow-y-auto rounded-3xl bg-white shadow-2xl">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2">
                                <div className="bg-navy text-white px-6 sm:px-8 lg:px-10 py-10">
                                ...
                                <div className="px-6 sm:px-8 lg:px-10 py-10">
                                    ...
                                    <div>
                                        <input
                                            ...
                                            className={`w-full border space-y-4 rounded-xl px-4 py-3 my-2 outline-none transition ${errors.email
                                                ? "border-red-500 focus:border-red-500"
                                                : "border-gray-200 focus:border-cora "
                                                }`}
                                        />
                                    ...
                                    <div>
                                        <textarea
                                            ...
                                            className={`w-full border rounded-xl px-4 py-3 outline-none resize-none transition ${errors.message
                                                ? "border-red-500 focus:border-red-500"
                                                : "border-gray-200 focus:border-coral"
                                                }`}
                                        />
