...
export default function ServiceIntro({
  ...
  description,
  colorClass,
  backgroundImage = "/images/shipping/waves.png",
}: ServiceIntroProps) {
  const fadeInUp = {
    ...
    >
      <motion.div {...fadeInUp}>
        <div className="relative z-10 max-w-5xl mx-auto">
          <h2 className={`${colorClass} text-3xl md:text-4xl font-bold mb-4`}>
            {title}
          </h2>
          ...
          <div className="mt-8 flex items-center justify-center gap-4">
            <div className={`h-px w-32 md:w-64 bg-current ${colorClass}`} />
